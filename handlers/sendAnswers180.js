...
OM.web("sendAnswers180", async (request) => {
    ...
    const data = await sendAnswer(
        ...
        addedElement,
        userMail,
        ENV.MAIN_LIST_QUESTIONS_180,
        ENV.MULTICUBE_SETTINGS_180,
        ENV.MULTICUBE_INPUT_ANSWERS_1,
        ENV.MULTICUBE_INPUT_ANSWERS_2,
        ENV.MULTICUBE_INPUT_ANSWERS_3,
        ENV.MULTICUBE_INPUT_ANSWERS_4,
